...
export let datasets: {[key: string]: dataset.DataGenerator} = {
  ...
  "diagonal": dataset.classifyDiagonalData,
  "ring": dataset.classifyRingData,
  "wave": dataset.classifyWaveData,
...
export let regDatasets: {[key: string]: dataset.DataGenerator} = {
  ...
  "reg-bowl": dataset.regressBowl,
  "reg-hills": dataset.regressHills,
  "reg-swiss": dataset.regressSwissRoll,
  "reg-radial": dataset.regressRadial,
  "reg-checker": dataset.regressCheckerboard,
...
export class State {
  ...
  private static PROPS: Property[] = [
    ...
    {name: "absX", type: Type.BOOLEAN},
    {name: "absY", type: Type.BOOLEAN},
    {name: "xCubed", type: Type.BOOLEAN},
    {name: "yCubed", type: Type.BOOLEAN},
    {name: "expX", type: Type.BOOLEAN},
    {name: "expY", type: Type.BOOLEAN},
    {name: "sigmoidX", type: Type.BOOLEAN},
    {name: "sigmoidY", type: Type.BOOLEAN},
